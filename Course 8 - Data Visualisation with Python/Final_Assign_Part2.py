...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(figure=px.bar(average_sales, x='Vehicle_Type', y='Automobile_Sales', title = 'Average Vehicle Sold by Vehicle Type'))
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        return [
            ...
            html.Div(className='chart-itme', children=[html.Div(children=R_chart3),html.Div(children=R_chart4)],style={'display':'flex'})
            ]
